...
--DBCC SHRINKFILE (BD2_Proyecto_Log, 1);

EXEC consulta1 'tt8111506'


EXEC consulta2 'Harry Potter'


SELECT * FROM [consulta3];


EXEC consulta4 'Lionel Messi'
...
-- DATABASE tables GENERAL INFO (FRAGMENTATION, PAGE COUNT, ETC.)
